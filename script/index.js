const loadData = async (searchFieldText) => {
    spinner(true);
    ...
    if (searchFieldText) {
        data = data.filter(post =>
            post.category.toLowerCase().includes(searchFieldText.toLowerCase()) ||
            post.title.toLowerCase().includes(searchFieldText.toLowerCase())
        );
    }
...
searchField.addEventListener('input', (e) => {
    ...
    handelSearch(searchFieldText);
});

const handelSearch = (searchFieldText) => {
